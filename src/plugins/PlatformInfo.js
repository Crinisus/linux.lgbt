  ...
  _createClass(PlatformInfo, [
    ...
    },
    {
      ...
      value: function getOSVersion() {
        ...
        switch (this.getOSPlatform()) {
          ...
          case 'windowsPhone':
            matcher = userAgent.match(
              /Windows (Mobile|Phone|Phone OS) [\d\.]+/
            );
    ...
    },
    {
      ...
      value: function getOSVersionNumber() {
        ...
        return this.getOSVersion()
          ? parseFloat(this.getOSVersion().match(/\d+(\.\d+)?/))
          : null;
      }
    },
    {
    ...
    },
    {
      ...
      value: function getBrowserVersion() {
        ...
        switch (this.getBrowser()) {
          ...
          case 'ie':
            matcher =
              userAgent.match(/MSIE [\d\.]+/) || userAgent.match(/rv\:[\d\.]+/);
    ...
    },
    {
      ...
      value: function isBrowserVersionHigherThan(version) {
        var testVersion = String(version)
          .replace(/_/g, '.')
          .split('.');
        ...
        switch (this.getOSPlatform()) {
          case 'mac':
            ...
            if (this.isOSVersionHigherThan('11')) {
              var webglContext = document.createElement('canvas').getContext
                ? document.createElement('canvas').getContext('webgl') ||
                  document
                    .createElement('canvas')
                    .getContext('experimental-webgl')
                : null; // WebGL is just... not available. So, we have to assume Intel.

              if (webglContext === null) {
                return 'amd64';
              }

              var debugInfo = webglContext.getExtension(
